...
public class LocationVerificationService extends Service {
    ...
    // Broadcast actions
    public static final String ACTION_LOCATION_UPDATED = "com.example.shedulytic.ACTION_LOCATION_UPDATED";
    public static final String ACTION_LOCATION_ERROR = "com.example.shedulytic.ACTION_LOCATION_ERROR";
    
    // Broadcast extras
    public static final String EXTRA_LATITUDE = "com.example.shedulytic.EXTRA_LATITUDE";
    public static final String EXTRA_LONGITUDE = "com.example.shedulytic.EXTRA_LONGITUDE";
    public static final String EXTRA_ACCURACY = "com.example.shedulytic.EXTRA_ACCURACY";
    public static final String EXTRA_ERROR_MESSAGE = "com.example.shedulytic.EXTRA_ERROR_MESSAGE";
