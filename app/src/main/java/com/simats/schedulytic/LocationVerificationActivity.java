...
public class LocationVerificationActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_HABIT_ID = "com.simats.schedulytic.EXTRA_HABIT_ID_LOC";
    public static final String EXTRA_HABIT_TITLE = "com.simats.schedulytic.EXTRA_HABIT_TITLE_LOC";
    public static final String EXTRA_HABIT_DESCRIPTION = "com.simats.schedulytic.EXTRA_HABIT_DESC_LOC";
    public static final String EXTRA_TARGET_LATITUDE = "com.simats.schedulytic.EXTRA_TARGET_LAT_LOC";
    public static final String EXTRA_TARGET_LONGITUDE = "com.simats.schedulytic.EXTRA_TARGET_LON_LOC";
